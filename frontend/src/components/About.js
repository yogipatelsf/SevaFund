...
const About = () => (
  <div className="container">
    ...
    <div className="content">
      ...
      <div className="row">
        <h4 className="what-is-sevafund">What is SevaFund?</h4>
        <p>
        ...
        <p>
          Seva happens all over the world, everyday. In Sikh gurudwaras, Buddhist and Hindu temples, Islamic mosques, Jewish synagogues and Christian churches, Seva is prevalent in everyone's lives. We at SevaFund are just that: a diverse group of JavaScript Web Developers with various religious and cultural backgrounds just trying to make an impact in the world with the use of technology.
        </p>
      </div>

      <div className="row">
        <h4 className="meet-the-team">Meet The Team</h4>
        <p>
          Here we are going to talk about what the foundation is and what we are
          envisioning for the future, the impact we want to have in the city of San
          Francisco and eventually in the rest of the country and the world.        
        </p>
      </div> 
