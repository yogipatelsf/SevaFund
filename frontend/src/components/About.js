  ...
  <div className="container">
    <div className="row">
      ...
      <p>
        ...
        community organizer; someone who tries to bring people together in order
        to serve a philanthropic or meaningful purpose? From the simple act of
        giving to a loved one, to clothing, feeding, and providing medical
        services to the poor, we have all tried to make the world a better
        place. If you're coming to this site, you already practice "Seva," a
        Sanskrit word that embodies the act of selfless service or sacrifice
        without the want or need of reward or repayment.
      </p>
      <p>
        Seva happens all over the world, everyday. In Sikh gurudwaras, Buddhist
        and Hindu temples, Islamic mosques, Jewish synagogues and Christian
        churches, Seva is prevalent in everyone's lives. We at SevaFund are just
        that: a diverse group of JavaScript Full Stack Web Developers with
        various cultural backgrounds just trying to make an impact in the world
    ...
    <div className="row">
      ...
      <p>
        ...
        Passport authentication system, but to provide a purchase order (PO) to
        us with their supplier's name. When a donor logs in (after
        authentication of signup using a similar Passport system) they will see
        the current POs listed by the charities, and be able to enter an amount
        of fiat money they would like to donate.
      </p>
      <p>
        Upon submission of donation, the information would communicate with, and
        update, a Solidity powered smart contract via a Web3 library. After
        multiple donations, and a 100% target-reach, a project would then be
        disabled, and the payment would go straight to the supplier. It is then
        the supplier's responsibility to fulfill their commitment to the
        charity, thus taking money out of the charitiy's hands. This undeniably
        brings transparency, and furthers a campaign of anti-corruption, to the
        world of nonprofits via the permanent general ledger of the Etherum
        blockchain.
      </p>
    </div>
